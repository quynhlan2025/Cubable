...
class BoardItemDropDown(MasterTest):
    def test_add_new_board(self):
        ...
        board_page.type_on_board_name("board dropdown")
        assert board_page.get_title_new_board() == "board dropdown"
        ...
        common.sleep(1)
        board_item_page.click_on_field_type("Dropdown")
        common.sleep(1)
        board_item_page.enter_field_name("Dropdown")
        board_item_page.enter_field_description("Dropdown")
        board_item_page.click_on_create_button()
        common.sleep(1)
        assert board_item_page.is_new_field_isdisplayed("Dropdown")
        common.sleep(1)