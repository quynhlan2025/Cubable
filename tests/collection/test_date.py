...
class BoardItemDateTest(MasterTest):
    def test_add_new_board(self):
        ...
        common.sleep(1)
        board_item_page.click_on_field_type("Date")
        common.sleep(1)
        board_item_page.enter_field_name("Date")
        board_item_page.enter_field_description("Date")
        board_item_page.click_on_create_button()
        common.sleep(1)
        assert board_item_page.is_new_field_isdisplayed("Date")
        common.sleep(1)