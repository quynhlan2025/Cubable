...
class BoardDocLinkTest(MasterTest):
    def test_add_new_board(self):
        ...
        board_page.type_on_board_name("board doc link")
        assert board_page.get_title_new_board() == "board doc link"
        ...
        common.sleep(1)
        board_item_page.click_on_field_type("Docs link")
        common.sleep(1)
        board_item_page.enter_field_name("Docs link")
        board_item_page.enter_field_description("Docs link")
        board_item_page.click_on_create_button()
        common.sleep(1)
        assert board_item_page.is_new_field_isdisplayed("Docs link")
        common.sleep(1)