...
class BoardItemLookup(MasterTest):
    def test_add_new_board(self):
        ...
        board_page.type_on_board_name("board lookup")
       # assert board_page.get_title_new_board() == "board A"
        ...
        common.sleep(1)
        board_item_page.click_on_field_type("Lookup")
        common.sleep(1)
        board_item_page.enter_field_name("Lookup")
        board_item_page.enter_field_description("Lookup")
        board_item_page.select_source_field("Created by","Phone")
        common.sleep(1)
       # board_item_page.click_on_create_button()
        common.sleep(50)
        #assert board_item_page.is_new_field_isdisplayed("Lookup")
        common.sleep(1)