...
class BoardRelationTest(MasterTest):
    def test_add_new_board(self):
        ...
        board_page.type_on_board_name("board relation")
        assert board_page.get_title_new_board() == "board relation"
        ...
        common.sleep(1)
        board_item_page.click_on_field_type("Relation")
        common.sleep(1)
        board_item_page.enter_field_name("Relation")
        board_item_page.enter_field_description("Relation")
        common.sleep(1)
        board_item_page.click_on_link_to_dropdown("Lan","Board A","Main view")
        board_item_page.click_on_create_button()
        common.sleep(1)
        assert board_item_page.is_new_field_isdisplayed("Relation")
