...
class BoardImageTest(MasterTest):
    def test_add_new_board(self):
        ...
        board_page.type_on_board_name("board image")
        assert board_page.get_title_new_board() == "board image"
        ...
        common.sleep(1)
        board_item_page.click_on_field_type("Image")
        common.sleep(1)
        board_item_page.enter_field_name("Image")
        board_item_page.enter_field_description("Image")
        board_item_page.click_on_create_button()
        common.sleep(1)
        assert board_item_page.is_new_field_isdisplayed("Image")
        common.sleep(1)