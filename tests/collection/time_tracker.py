...
class BoardItemTextFieldTest(MasterTest):
    ...
    def test_add_new_board(self):
        ...
        board_page.type_on_board_name("board timetracker")
        assert board_page.get_title_new_board() == "board timetracker"
       ...
       # assert board_item_page.is_field_value_displayed("item name:") == True
        ...
        common.sleep(5)
        board_item_page.click_on_field_type("Text")
        common.sleep(1)
        board_item_page.enter_field_name("Time Tracker")
        board_item_page.enter_field_description("Time Tracker")
