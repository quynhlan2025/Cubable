...
class BoardItemParagraphTest(MasterTest):
    ...
    def test_add_new_board(self):
        ...
        board_page.type_on_board_name("board paragraph")
        assert board_page.get_title_new_board() == "board paragraph"
       ...
       # assert board_item_page.is_field_value_displayed("item name:") == True
        ...
        common.sleep(5)
        board_item_page.click_on_field_type("Paragraph")
        common.sleep(1)
        board_item_page.enter_field_name("Paragraph")
        board_item_page.enter_field_description("Paragraph")
        board_item_page.click_on_create_button()
        common.sleep(1)
        assert board_item_page.is_new_field_isdisplayed("Paragraph")
        common.sleep(1)
        pass
